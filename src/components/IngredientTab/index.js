...
export default class IngredientTab extends Component {
  render() {
    ...
    return (
      <ul className="select-none animated fadeInDown bg-white fixed list-reset w-full items-center flex flex-wrap overflow-x-hidden overflow-y-scroll border-t font-semibold" style={{ bottom: '80px', maxHeight: '300px', height: '20vh' }}>
